...
class ThreeForTwoDiscountCalculatorTest {

    private final ThreeForTwoDiscountCalculator sut = new ThreeForTwoDiscountCalculator();
    ...
    void getAmountStrategy_MethodCalled_CorrectAmountStrategyReturned() {
        ...
        // then
        assertThat(result).isEqualTo(AmountStrategy.THREE_FOR_TWO);
    }
    ...
    private static Stream<Arguments> amountTestData() {
        return Stream.<Arguments>builder()
                ...
                .add(Arguments.of(3, new BigDecimal(1), new BigDecimal(2)))
                .add(Arguments.of(4, new BigDecimal(1), new BigDecimal(3)))
                .add(Arguments.of(1, new BigDecimal(5), new BigDecimal(5)))
                .add(Arguments.of(2, new BigDecimal(5), new BigDecimal(10)))
                .add(Arguments.of(3, new BigDecimal(5), new BigDecimal(10)))
                .add(Arguments.of(4, new BigDecimal(5), new BigDecimal(15)))
                .build();
    }
}